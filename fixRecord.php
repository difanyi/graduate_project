...
function saverecord(){  
    ...
    document.getElementById('newform').action = "php/saverecord.php?patientID=<?php echo $patientid;?>";
    ...
    <div class="cloudClinic-main flt" id="cloudClinic-main" style="height: 556px;">
        ...
        <div class="page-main-content flt" id="page-main-content" style="width: 1211px;">
            ...
            <div class="fixed-panel top-fixed" id="top-fixed-panel">
                <div class="nav-fixed">
                    <div class="nav-btn">	
                        <label style="font-size:25px;font-weight:bold;margin-right：20px;">编辑病例</label>
...
$sql="select * from patient,record where patient.id=$patientid and record.patient_id=$patientid";
...
?>
    ...
    <b class="info-must">*</b><b>姓名:</b><?php  echo " ".$row['patname'];?>
	<ul class="sug-ul-dom " style="border: 1px solid rgb(223, 223, 223); width: 229.567px; display: none;"></ul>
    </p>
    ...
    <?php echo $row['age_number']."  ".$row['age_unit'];?>
    </p>
							
    <p class="single-information phone">
        <b>电话:</b><input type="text" name="patient-tel" value="<?php echo $row['pattel'];?>"  onfocus="if (value =='<?php echo $row['pattel'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['pattel'];?>'}" class="phone-num zh-ipt recordIpt p_patientPhone">
    </p>
</div>
</div> 
                        <div class="first-patient-history autoHeight">
                            ...
                            <div>
							<input name="zhusu" value="<?php echo $row['zhusu'];?>"  onfocus="if (value =='<?php echo $row['zhusu'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['zhusu'];?>'}" class="patient-old recordIpt autoIpt gr-border J_divEditable" contenteditable="true" id="zhusu" onkeyup="aa()"/>
							</div>
						</div>
                        <div class="patient-history autoHeight">
                            <p class="autoTitle">既往史:</p>
							<div><input name="jiwang" value="<?php echo $row['jiwang'];?>"  onfocus="if (value =='<?php echo $row['jiwang'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['jiwang'];?>'}"class="patient-history zh-ipt2 recordIpt autoIpt p_previousHistory gr-border J_divEditable" contenteditable="true" id="jiwang" onkeyup="aa()"/></div>
                        </div>
                        <div class="patient-history autoHeight">
                            <p class="autoTitle">个人史:</p>
							<div><input name="geren" value="<?php echo $row['geren'];?>"  onfocus="if (value =='<?php echo $row['geren'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['geren'];?>'}" class="patient-history zh-ipt2 recordIpt autoIpt p_personalHistory gr-border J_divEditable" contenteditable="true" id="geren" onkeyup="aa()"/></div>
                        </div>
                        <div class="patient-history2 autoHeight">
                            <p class="autoTitle">过敏史:</p>
                            <div><input name="guomin" value="<?php echo $row['guomin'];?>"  onfocus="if (value =='<?php echo $row['guomin'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['guomin'];?>'}" class="patient-history2 zh-ipt2 recordIpt autoIpt p_allergyHistory gr-border J_divEditable" contenteditable="true"/></div>
							
                        </div>
                        <div class="patient-history2 autoHeight">
                            <p class="autoTitle">家族史:</p>
                            
							<div><input name="jiazu" value="<?php echo $row['jiazu'];?>"  onfocus="if (value =='<?php echo $row['jiazu'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['jiazu'];?>'}" class="patient-history zh-ipt2 recordIpt autoIpt p_previousHistory gr-border J_divEditable" contenteditable="true" id="jiazu" onkeyup="aa()"/></div>
                        </div>
                    </div>
                    <div class="main-mid">
                ...
                <p class="check-up same-line">
                    &nbsp;体温:<input type="text" value="<?php echo $row['pattem'];?>"  onfocus="if (value =='<?php echo $row['pattem'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['pattem'];?>'}" name="patient-tem"  id="patient-tem" class="zh-ipt recordIpt numIpt p_temperature">℃
                </p>
                <p class="check-up same-line">
                    体重:<input type="text" name="patient-weight"  id="patient-weight" value="<?php echo $row['patweight'];?>"  onfocus="if (value =='<?php echo $row['patweight'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['patweight'];?>'}" class="zh-ipt recordIpt numIpt p_weight">KG
                </p>
                <p class="check-up same-line check-up2">
                    心率:<input type="text" name="patient-rate" id="patient-rate" value="<?php echo $row['patrate'];?>"  onfocus="if (value =='<?php echo $row['patrate'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['patrate'];?>'}" class="zh-ipt recordIpt numIpt p_heartRate">bpm
                </p>
                <p class="check-up1 same-line">
                    血压:<input type="text" placeholder="收缩压" name="patient-blood1" id="patient-blood1" value="<?php echo $row['patblood1'];?>"  onfocus="if (value =='<?php echo $row['patblood1'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['patblood1'];?>'}" class="zh-ipt1 recordIpt numIpt p_bloodPressureSBP">/<input type="text" placeholder="舒张压" name="patient-blood2"  id="patient-blood2" value="<?php echo $row['patblood2'];?>"  onfocus="if (value =='<?php echo $row['patblood2'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['patblood2'];?>'}" class="zh-ipt1 recordIpt numIpt p_bloodPressureDBP">mmHg
                </p>
                            <p class="other">
                                <input autoheight="true"  <input type="text" value="<?php echo $row['tigejiancha'];?>"  onfocus="if (value =='<?php echo $row['tigejiancha'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['tigejiancha'];?>'}" name="other" id="other" placeholder="其他体格检查" class="zh-ipt recordIpt p_otherPhysique" onkeyup="aa()"></input>
                            </p>
                        </div>
                    </div>
                    <div class="main-mid2">
                        <div class="there-line">
							...
							<input autoheight="true" name="zhenduan" <input type="text" value="<?php echo $row['zhenduan'];?>"  onfocus="if (value =='<?php echo $row['zhenduan'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['zhenduan'];?>'}" ></input>
                    ...
                    <div class="doctorSay autoHeight">
                        ...
                        <div class="single-line">
							...
							<input  <input type="text" value="<?php echo $row['yizhu'];?>"  onfocus="if (value =='<?php echo $row['yizhu'];?>'){value =''}" onblur="if (value ==''){value='<?php echo $row['yizhu'];?>'}" autoheight="true" name="yizhu" class="zh-ipt2 recordIpt autoIpt2 gr-border J_divEditable J_advice_content" contenteditable="true" ></input>
