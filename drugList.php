        ...
        <div class="page-main-content flt" id="page-main-content" style="width: 1211px;">
            ...
            <div class="fixed-panel top-fixed" id="top-fixed-panel">
                <div class="header f-clrfix">
                    ...
                    <input style="margin-left:25px;"class="short-btn" type="submit" name="drugList"value="查询" onclick="">
...
<div>
								...
								<td class="short-width"><a class="link-edit" href="addDrug.php?id=<?php echo $row['Yp_id'];?>">编辑</a>&nbsp;|&nbsp;<a class="link-edit J_deleteDrug">删除</a></td></tr>
